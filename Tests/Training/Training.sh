...
function execute() 
{
    ...
    python Training/training.py --name model -m no_lstm -b 50 --train test-files/nanox_unpacked/train.txt --test test-files/nanox_unpacked/test.txt -e 2 || return 1 
    ...
    python Training/training_da.py --name da -b 50 --train test-files/nanox_unpacked/train.txt --test test-files/nanox_unpacked/test.txt --trainDA test-files/nanox_unpacked/da_train.txt --testDA test-files/nanox_unpacked/da_test.txt -e 2 || return 1 
    ...
    python Training/training_da.py --name da_wasser --wasserstein -b 50 --train test-files/nanox_unpacked/train.txt --test test-files/nanox_unpacked/test.txt --trainDA test-files/nanox_unpacked/da_train.txt --testDA test-files/nanox_unpacked/da_test.txt -e 2 || return 1 
}
